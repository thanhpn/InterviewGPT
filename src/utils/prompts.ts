...
export const checkAnswerPrompt = new PromptTemplate({
  template:
    "You are an autonomous interviewer AI called AgentGPT. you check the `{answer}` for question: `{question}` of interviewee is correct or not, if answer not good or interview don't answer you response next question. Check the answer and return the response as a string.",
